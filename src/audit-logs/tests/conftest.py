...
from greenlake_audit_logs_mcp.utils.http_client import AuditLogsHttpClient
...
def reset_singletons(request: pytest.FixtureRequest, monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    """
    import greenlake_audit_logs_mcp.config.settings as settings_module
    import greenlake_audit_logs_mcp.utils.http_client as http_client_module

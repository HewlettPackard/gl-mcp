...
"""
Tests for version information module in audit-logs MCP server.
...
def test_version_module_imports():
    ...
    from greenlake_audit_logs_mcp._version import SERVER_NAME, SERVER_VERSION, USER_AGENT
...
def test_server_name_format():
    ...
    from greenlake_audit_logs_mcp._version import SERVER_NAME
...
def test_server_version_format():
    ...
    from greenlake_audit_logs_mcp._version import SERVER_VERSION
...
def test_user_agent_format():
    ...
    from greenlake_audit_logs_mcp._version import USER_AGENT, SERVER_NAME, SERVER_VERSION
...
def test_user_agent_no_spaces():
    ...
    from greenlake_audit_logs_mcp._version import USER_AGENT

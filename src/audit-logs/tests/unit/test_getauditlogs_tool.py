...
Tests the getauditlogs FastMCP tool function directly by mocking
...
class TestGetauditlogsTool:
    """Test cases for the getauditlogs tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getauditlogs(ctx)

...
@mcp.tool(
    ...
    description="Executes any devices API endpoint dynamically with parameter validation and schema support",
)
async def invoke_dynamic_tool(
    ...
    """Executes any devices API endpoint dynamically with parameter validation.

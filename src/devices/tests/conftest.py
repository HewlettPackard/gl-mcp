...
from greenlake_devices_mcp.utils.http_client import DevicesHttpClient
...
def reset_singletons(request: pytest.FixtureRequest, monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    """
    import greenlake_devices_mcp.config.settings as settings_module
    import greenlake_devices_mcp.utils.http_client as http_client_module

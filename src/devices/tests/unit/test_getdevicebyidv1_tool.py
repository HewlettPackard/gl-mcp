...
Tests the getdevicebyidv1 FastMCP tool function directly by mocking
...
from greenlake_devices_mcp.tools.implementations.getdevicebyidv1 import getdevicebyidv1 as _impl_getdevicebyidv1
...
class TestGetdevicebyidv1Tool:
    """Test cases for the getdevicebyidv1 tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getdevicebyidv1(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getdevicebyidv1(ctx)

...
Tests the getdevicesv1 FastMCP tool function directly by mocking
...
from greenlake_devices_mcp.tools.implementations.getdevicesv1 import getdevicesv1 as _impl_getdevicesv1
...
class TestGetdevicesv1Tool:
    """Test cases for the getdevicesv1 tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getdevicesv1(ctx)

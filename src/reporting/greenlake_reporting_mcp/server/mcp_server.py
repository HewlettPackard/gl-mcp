...
"""
MCP server implementation for reporting.
...
from greenlake_reporting_mcp.server.fastmcp_instance import mcp  # noqa: F401  (re-exported for convenience)
from greenlake_reporting_mcp.tools.registry import get_tool_classes

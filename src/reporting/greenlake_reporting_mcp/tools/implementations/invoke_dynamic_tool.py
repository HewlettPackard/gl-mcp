...
@mcp.tool(
    ...
    description="Executes any reporting API endpoint dynamically with parameter validation and schema support",
)
async def invoke_dynamic_tool(
    ...
    """Executes any reporting API endpoint dynamically with parameter validation.
    ...
    endpoint_schemas: dict[str, Any] = {
        ...
        "GET:/reporting/v1/statuses": {
            ...
            "parameters": [
                {"name": "filter", "type": "str", "description": "filter", "required": True, "location": "query"},

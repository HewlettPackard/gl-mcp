...
"""End-to-End tests for reporting MCP Server.
...
class TestReportingMCPServerE2E:
    """End-to-End tests for the reporting MCP server.
    ...
    async def test_server_health(self):
        ...
        try:
            ...
            session, session_cm, stdio_transport, stdio_client_cm, process = await create_mcp_session(
                "greenlake_reporting_mcp.server.app"
            )

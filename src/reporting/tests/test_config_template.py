...
"""
Tests for config components in reporting MCP server.
...
class TestSettings:
    ...
    def test_settings_service_specific_config(self):
        """Test service-specific configuration for reporting."""
...
class TestLogging:
    ...
    def test_setup_logging_default(self):
        ...
        logger = get_logger("test_reporting")
    ...
    def test_setup_logging_with_level(self):
        ...
        for level in levels:
            ...
            logger = get_logger("test_level_reporting")
    ...
    def test_get_logger_names(self):
        """Test logger naming for reporting."""
        # Test various logger names
        test_names = [
            "reporting.auth",
            "reporting.server",
            "reporting.tools",
            "reporting.http_client",
        ]
    ...
    def test_logging_output_format(self):
        ...
        setup_logging()
        logger = get_logger("format_test_reporting")

        # Test that logger can handle different log levels
        logger.info("Test info message for reporting")
        logger.warning("Test warning message for reporting")
        logger.error("Test error message for reporting")
    ...
    def test_structured_logging(self):
        ...
        setup_logging()
        logger = get_logger("structured_test_reporting")
    ...
    def test_logging_with_environment_config(self):
        ...
        with patch.dict(os.environ, test_env, clear=False):
            setup_logging()
            logger = get_logger("env_test_reporting")

            # Should create logger successfully with env config
            assert logger is not None

    def test_logger_hierarchy(self):
        """Test logger hierarchy for reporting components."""
        setup_logging()

        # Create loggers with hierarchical names
        root_logger = get_logger("reporting")
        auth_logger = get_logger("reporting.auth")
        server_logger = get_logger("reporting.server")
...
class TestConfigIntegration:
    ...
    def test_settings_and_logging_integration(self):
        ...
        logger = get_logger("integration_test_reporting")
    ...
    def test_config_validation_with_dependencies(self):
        ...
        with patch.dict(os.environ, test_env, clear=False):
            ...
            # Validate required fields for reporting
...
class TestConfigSecurity:
    ...
    def test_sensitive_data_not_logged(self):
        ...
        setup_logging()
        logger = get_logger("security_test_reporting")

        # Create settings with sensitive data
        test_env = {
            "GREENLAKE_CLIENT_ID": "test-client-id-security",
            "GREENLAKE_CLIENT_SECRET": "super-secret-value-reporting",
            "GREENLAKE_WORKSPACE_ID": "test-workspace-id-security",
            "TOKEN_ISSUER": "https://secure.reporting.com/oauth2/token",
        }
...
def mock_config_file():
    ...
    config_content = """
    CLIENT_ID=mock-client-id-reporting
    CLIENT_SECRET=mock-client-secret-reporting
    TOKEN_ISSUER=https://mock.reporting.com/oauth2/token
...
class TestConfigEdgeCases:
    ...
    def test_unicode_config_values(self):
        ...
        unicode_env = {
            "CLIENT_ID": "test-中文-reporting",
            "TOKEN_ISSUER": "https://тест.reporting.com/oauth2/token",
        }

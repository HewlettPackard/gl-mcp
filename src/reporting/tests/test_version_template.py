...
"""
Tests for version information module in reporting MCP server.
...
def test_version_module_imports():
    ...
    from greenlake_reporting_mcp._version import SERVER_NAME, SERVER_VERSION, USER_AGENT
...
def test_server_name_format():
    ...
    from greenlake_reporting_mcp._version import SERVER_NAME
...
def test_server_version_format():
    ...
    from greenlake_reporting_mcp._version import SERVER_VERSION
...
def test_user_agent_format():
    ...
    from greenlake_reporting_mcp._version import USER_AGENT, SERVER_NAME, SERVER_VERSION

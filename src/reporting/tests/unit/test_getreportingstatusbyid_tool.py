...
"""
Test for getreportingstatusbyid tool in reporting MCP server.

Tests the getreportingstatusbyid FastMCP tool function directly by mocking
...
class TestGetreportingstatusbyidTool:
    """Test cases for the getreportingstatusbyid tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getreportingstatusbyid(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getreportingstatusbyid(ctx)

...
"""
Test for getreportingstatuses tool in reporting MCP server.

Tests the getreportingstatuses FastMCP tool function directly by mocking
...
class TestGetreportingstatusesTool:
    """Test cases for the getreportingstatuses tool function."""

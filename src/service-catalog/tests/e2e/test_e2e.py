...
"""End-to-End tests for service-catalog MCP Server.
...
class TestServiceCatalogMCPServerE2E:
    """End-to-End tests for the service-catalog MCP server.
    ...
    async def test_server_health(self):
        ...
        try:
            ...
            session, session_cm, stdio_transport, stdio_client_cm, process = await create_mcp_session(
                "greenlake_service_catalog_mcp.server.app"
            )

...
"""
Test for get_service_manager_provision_v1 tool in service-catalog MCP server.

Tests the get_service_manager_provision_v1 FastMCP tool function directly by mocking
...
class TestGetServiceManagerProvisionV1Tool:
    """Test cases for the get_service_manager_provision_v1 tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_get_service_manager_provision_v1(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_get_service_manager_provision_v1(ctx)

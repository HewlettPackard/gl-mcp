...
"""
Test for getserviceoffer tool in service-catalog MCP server.

Tests the getserviceoffer FastMCP tool function directly by mocking
...
class TestGetserviceofferTool:
    """Test cases for the getserviceoffer tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceoffer(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceoffer(ctx)

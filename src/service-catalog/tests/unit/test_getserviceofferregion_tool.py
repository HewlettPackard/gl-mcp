...
"""
Test for getserviceofferregion tool in service-catalog MCP server.

Tests the getserviceofferregion FastMCP tool function directly by mocking
...
class TestGetserviceofferregionTool:
    """Test cases for the getserviceofferregion tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceofferregion(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceofferregion(ctx)

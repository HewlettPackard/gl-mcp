...
"""
Test for getserviceofferregions tool in service-catalog MCP server.

Tests the getserviceofferregions FastMCP tool function directly by mocking
...
class TestGetserviceofferregionsTool:
    """Test cases for the getserviceofferregions tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceofferregions(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceofferregions(ctx)

...
"""
Test for getserviceoffers tool in service-catalog MCP server.

Tests the getserviceoffers FastMCP tool function directly by mocking
...
class TestGetserviceoffersTool:
    """Test cases for the getserviceoffers tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceoffers(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceoffers(ctx)

...
"""
Test for getserviceprovision tool in service-catalog MCP server.

Tests the getserviceprovision FastMCP tool function directly by mocking
...
class TestGetserviceprovisionTool:
    """Test cases for the getserviceprovision tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceprovision(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceprovision(ctx)

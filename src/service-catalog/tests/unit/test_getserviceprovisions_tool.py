...
"""
Test for getserviceprovisions tool in service-catalog MCP server.

Tests the getserviceprovisions FastMCP tool function directly by mocking
...
class TestGetserviceprovisionsTool:
    """Test cases for the getserviceprovisions tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getserviceprovisions(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getserviceprovisions(ctx)

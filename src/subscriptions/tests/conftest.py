...
from greenlake_subscriptions_mcp.utils.http_client import SubscriptionsHttpClient
...
def reset_singletons(request: pytest.FixtureRequest, monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    """
    import greenlake_subscriptions_mcp.config.settings as settings_module
    import greenlake_subscriptions_mcp.utils.http_client as http_client_module

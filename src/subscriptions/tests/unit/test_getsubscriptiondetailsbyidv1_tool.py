...
Tests the getsubscriptiondetailsbyidv1 FastMCP tool function directly by mocking
...
class TestGetsubscriptiondetailsbyidv1Tool:
    """Test cases for the getsubscriptiondetailsbyidv1 tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getsubscriptiondetailsbyidv1(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getsubscriptiondetailsbyidv1(ctx)

...
Tests the getsubscriptionsv1 FastMCP tool function directly by mocking
...
class TestGetsubscriptionsv1Tool:
    """Test cases for the getsubscriptionsv1 tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_getsubscriptionsv1(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_getsubscriptionsv1(ctx)

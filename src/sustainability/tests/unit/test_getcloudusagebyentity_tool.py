...
"""
Test for getcloudusagebyentity tool in Sustainability_Insight_Center MCP server.

Tests the getcloudusagebyentity FastMCP tool function directly by mocking
...
class TestGetcloudusagebyentityTool:
    """Test cases for the getcloudusagebyentity tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getcloudusagebyentity(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await getcloudusagebyentity(ctx)

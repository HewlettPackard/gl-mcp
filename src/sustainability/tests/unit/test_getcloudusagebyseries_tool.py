...
"""
Test for getcloudusagebyseries tool in Sustainability_Insight_Center MCP server.

Tests the getcloudusagebyseries FastMCP tool function directly by mocking
...
class TestGetcloudusagebyseriesTool:
    """Test cases for the getcloudusagebyseries tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getcloudusagebyseries(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await getcloudusagebyseries(ctx)

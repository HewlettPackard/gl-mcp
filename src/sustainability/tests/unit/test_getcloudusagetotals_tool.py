...
"""
Test for getcloudusagetotals tool in Sustainability_Insight_Center MCP server.

Tests the getcloudusagetotals FastMCP tool function directly by mocking
...
class TestGetcloudusagetotalsTool:
    """Test cases for the getcloudusagetotals tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getcloudusagetotals(ctx)

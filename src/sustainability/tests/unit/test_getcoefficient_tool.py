...
"""
Test for getcoefficient tool in Sustainability_Insight_Center MCP server.

Tests the getcoefficient FastMCP tool function directly by mocking
...
class TestGetcoefficientTool:
    """Test cases for the getcoefficient tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getcoefficient(ctx)

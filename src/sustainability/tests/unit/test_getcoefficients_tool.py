...
"""
Test for getcoefficients tool in Sustainability_Insight_Center MCP server.

Tests the getcoefficients FastMCP tool function directly by mocking
...
class TestGetcoefficientsTool:
    """Test cases for the getcoefficients tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getcoefficients(ctx)

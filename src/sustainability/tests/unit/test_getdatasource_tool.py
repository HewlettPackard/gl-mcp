...
"""
Test for getdatasource tool in Sustainability_Insight_Center MCP server.

Tests the getdatasource FastMCP tool function directly by mocking
...
class TestGetdatasourceTool:
    """Test cases for the getdatasource tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getdatasource(ctx)

...
"""
Test for getdatasources tool in Sustainability_Insight_Center MCP server.

Tests the getdatasources FastMCP tool function directly by mocking
...
class TestGetdatasourcesTool:
    """Test cases for the getdatasources tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getdatasources(ctx)

...
"""
Test for getingest tool in Sustainability_Insight_Center MCP server.

Tests the getingest FastMCP tool function directly by mocking
...
class TestGetingestTool:
    """Test cases for the getingest tool function."""

...
"""
Test for getingests tool in Sustainability_Insight_Center MCP server.

Tests the getingests FastMCP tool function directly by mocking
...
class TestGetingestsTool:
    """Test cases for the getingests tool function."""

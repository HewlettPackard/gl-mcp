...
"""
Test for getusagebyentity tool in Sustainability_Insight_Center MCP server.

Tests the getusagebyentity FastMCP tool function directly by mocking
...
class TestGetusagebyentityTool:
    """Test cases for the getusagebyentity tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getusagebyentity(ctx)

...
"""
Test for getusagebyseries tool in Sustainability_Insight_Center MCP server.

Tests the getusagebyseries FastMCP tool function directly by mocking
...
class TestGetusagebyseriesTool:
    """Test cases for the getusagebyseries tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getusagebyseries(ctx)

...
"""
Test for getusagetotals tool in Sustainability_Insight_Center MCP server.

Tests the getusagetotals FastMCP tool function directly by mocking
...
class TestGetusagetotalsTool:
    """Test cases for the getusagetotals tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await getusagetotals(ctx)

...
"""
getcloudusagebyentity tool implementation for sustainability MCP server.

This tool gets public cloud sustainability data grouped by entity.
"""
...
class getcloudusagebyentityTool(BaseTool):
    """Get public cloud sustainability data grouped by entity. Returns CO2 emissions data for cloud services (AWS, Azure, etc.) per service account and region."""

    @property
    def name(self) -> str:
        """Tool name."""
        return "getcloudusagebyentity"

    @property
    def description(self) -> str:
        """Tool description."""
        return "Get public cloud sustainability data grouped by entity. Returns CO2 emissions data for cloud services (AWS, Azure, etc.) per service account and region."
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Execute the getcloudusagebyentity tool.

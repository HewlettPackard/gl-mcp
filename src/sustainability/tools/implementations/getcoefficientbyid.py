...
"""
getcoefficientbyid tool implementation for sustainability MCP server.

This tool gets a specific cost and CO2 coefficient by ID.
"""
...
class getcoefficientbyidTool(BaseTool):
    """Get a specific cost and CO2 coefficient by ID."""

    @property
    def name(self) -> str:
        """Tool name."""
        return "getcoefficientbyid"

    @property
    def description(self) -> str:
        """Tool description."""
        return "Get a specific cost and CO2 coefficient by ID."
    ...
    def input_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "id": {
                    "type": "string",
                    "description": "The UUID of the coefficient to retrieve.",
                },
            },
            "required": [
                "id",
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Execute the getcoefficientbyid tool.

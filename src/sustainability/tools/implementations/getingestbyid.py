...
"""
getingestbyid tool implementation for sustainability MCP server.

This tool gets metadata for a specific uploaded device measurement by ID.
"""
...
class getingestbyidTool(BaseTool):
    """Get metadata for a specific uploaded device measurement by ID."""

    @property
    def name(self) -> str:
        """Tool name."""
        return "getingestbyid"

    @property
    def description(self) -> str:
        """Tool description."""
        return "Get metadata for a specific uploaded device measurement by ID."
    ...
    def input_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "id": {
                    "type": "string",
                    "description": "The UUID of the ingest record to retrieve.",
                },
            },
            "required": [
                "id",
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Execute the getingestbyid tool.

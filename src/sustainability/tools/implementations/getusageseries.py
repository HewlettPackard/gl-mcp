...
"""
getusageseries tool implementation for sustainability MCP server.

This tool gets energy usage data grouped by time buckets.
"""
...
class getusageseriesTool(BaseTool):
    """Get energy usage data grouped by time buckets. Returns time series of energy consumption (kWh), carbon footprint (CO2e metric tons), and cost."""

    @property
    def name(self) -> str:
        """Tool name."""
        return "getusageseries"

    @property
    def description(self) -> str:
        """Tool description."""
        return "Get energy usage data grouped by time buckets. Returns time series of energy consumption (kWh), carbon footprint (CO2e metric tons), and cost. The interval parameter format is 'integer unit' (e.g. '1 day', '2 hours', '1 month', '1 year')."
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Execute the getusageseries tool.

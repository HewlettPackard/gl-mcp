...
"""
invoke_dynamic_tool tool implementation for Sustainability_Insight_Center MCP server.
...
class InvokeDynamicTool(BaseTool):
    """Executes any Sustainability_Insight_Center API endpoint dynamically with schema validation."""
    ...
    def description(self) -> str:
        """Tool description."""
        return "Executes any Sustainability_Insight_Center API endpoint dynamically with parameter validation and schema support"
    ...
    def _build_request_url(self, base_path: str, parameters: Dict[str, Any], schema: Dict[str, Any]) -> tuple[str, Dict[str, Any]]:

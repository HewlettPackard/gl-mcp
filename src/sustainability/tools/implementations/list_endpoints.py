...
"""
list_endpoints tool implementation for sustainability MCP server.
...
class ListEndpointsTool(BaseTool):
    ...
    def description(self) -> str:
        """Tool description."""
        return "Lists all available sustainability API endpoints as simple identifiers (method:path format) for fast discovery and selection"

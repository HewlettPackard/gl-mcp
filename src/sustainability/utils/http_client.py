...
"""
HTTP client for Sustainability_Insight_Center MCP server.
...
class SustainabilityInsightCenterHttpClient:
    """HTTP client for Sustainability_Insight_Center API with authentication."""
    ...
    async def get(self, endpoint: str, params: Optional[Dict[str, Any]] = None, additional_headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
    ...
    async def post(self, endpoint: str, data: Optional[Dict[str, Any]] = None, additional_headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
    ...
    async def put(self, endpoint: str, data: Optional[Dict[str, Any]] = None, additional_headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
...
def get_http_client() -> "SustainabilityInsightCenterHttpClient":
    """Get the global HTTP client instance (lazy initialization)."""
    global _http_client
    if _http_client is None:
        _http_client = SustainabilityInsightCenterHttpClient()
    return _http_client

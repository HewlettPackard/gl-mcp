...
"""
HTTP client for sustainability MCP server.
...
class SustainabilityHttpClient:
    """HTTP client for sustainability API with authentication."""
...
def get_http_client() -> "SustainabilityHttpClient":
    """Get the global HTTP client instance (lazy initialization)."""
    global _http_client
    if _http_client is None:
        _http_client = SustainabilityHttpClient()
    return _http_client

...
@mcp.tool(
    ...
    description="Executes any users API endpoint dynamically with parameter validation and schema support",
)
async def invoke_dynamic_tool(
    ...
    """Executes any users API endpoint dynamically with parameter validation.

...
from greenlake_users_mcp.utils.http_client import UsersHttpClient, get_http_client
...
def _maybe_patch_token_manager(manager_mock):
    ...
    with patch("greenlake_users_mcp.utils.http_client.TokenManager", return_value=manager_mock):
        yield
...
class TestHttpClientFactory:
    ...
    def test_get_http_client(self):
        ...
        with patch("greenlake_users_mcp.utils.http_client.UsersHttpClient") as mock_client_class:
            mock_client = Mock()
    ...
    def test_get_http_client_multiple_calls(self):
        ...
        import greenlake_users_mcp.utils.http_client as _http_mod

        _http_mod._http_client = None
        # Mock TokenManager to avoid real authentication
        with patch("greenlake_users_mcp.utils.http_client.TokenManager") as mock_token_manager_class:

...
Tests the get_user_detailed_identity_v1_users_id_get FastMCP tool function directly by mocking
...
from greenlake_users_mcp.tools.implementations.get_user_detailed_identity_v1_users_id_get import (
    get_user_detailed_identity_v1_users_id_get as _impl_get_user_detailed_identity_v1_users_id_get,
)
...
class TestGetUserDetailedIdentityV1UsersIdGetTool:
    """Test cases for the get_user_detailed_identity_v1_users_id_get tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_get_user_detailed_identity_v1_users_id_get(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_get_user_detailed_identity_v1_users_id_get(ctx)

...
Tests the get_users_identity_v1_users_get FastMCP tool function directly by mocking
...
from greenlake_users_mcp.tools.implementations.get_users_identity_v1_users_get import (
    get_users_identity_v1_users_get as _impl_get_users_identity_v1_users_get,
)
...
class TestGetUsersIdentityV1UsersGetTool:
    """Test cases for the get_users_identity_v1_users_get tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_get_users_identity_v1_users_get(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_get_users_identity_v1_users_get(ctx)

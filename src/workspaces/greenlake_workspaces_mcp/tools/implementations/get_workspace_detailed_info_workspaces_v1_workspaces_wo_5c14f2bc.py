...
"""
get_workspace_detailed_info_workspaces_v1_workspaces_wo_5c14f2bc tool for workspaces MCP server.

Implements: GET /workspaces/v1/workspaces/{workspaceId}/contact
"""
...
async def get_workspace_detailed_info_workspaces_v1_workspaces_wo_5c14f2bc(  # noqa: E501
    ctx: Context,
    ...
    try:
        ...
        logger.error(f"Validation error in get_workspace_detailed_info_workspaces_v1_workspaces_wo_5c14f2bc: {exc}")
        return [{"success": False, "error": "validation_error", "message": str(exc)}]

    except Exception as exc:
        logger.error(f"Error in get_workspace_detailed_info_workspaces_v1_workspaces_wo_5c14f2bc: {exc}", exc_info=True)

...
from greenlake_workspaces_mcp.config.settings import Settings
from greenlake_workspaces_mcp.utils.http_client import WorkspacesHttpClient
...
def reset_singletons(request: pytest.FixtureRequest, monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    """
    import greenlake_workspaces_mcp.config.settings as settings_module
    import greenlake_workspaces_mcp.utils.http_client as http_client_module

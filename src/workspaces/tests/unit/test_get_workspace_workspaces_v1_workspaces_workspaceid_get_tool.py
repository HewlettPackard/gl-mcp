...
Tests the get_workspace_workspaces_v1_workspaces_workspaceid_get FastMCP tool function directly by mocking
...
from greenlake_workspaces_mcp.tools.implementations.get_workspace_workspaces_v1_workspaces_workspaceid_get import (
    get_workspace_workspaces_v1_workspaces_workspaceid_get as _impl_get_workspace_workspaces_v1_workspaces_workspaceid_get,
)
...
class TestGetWorkspaceWorkspacesV1WorkspacesWorkspaceidGetTool:
    """Test cases for the get_workspace_workspaces_v1_workspaces_workspaceid_get tool function."""
    ...
    async def test_returns_list(self):
        ...
        result = await _impl_get_workspace_workspaces_v1_workspaces_workspaceid_get(ctx)
    ...
    async def test_http_client_called_once(self):
        ...
        await _impl_get_workspace_workspaces_v1_workspaces_workspaceid_get(ctx)
